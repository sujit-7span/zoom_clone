...
namespace ZOOM_SDK_DOTNET_WRAP {
	...
	public delegate void onRecordPrivilegeChanged(bool bCanRec);
	...
	public:
		...
		void Add_CB_onRecordPrivilegeChanged(onRecordPrivilegeChanged^ cb);
		...
		void Remove_CB_onRecordPrivilegeChanged(onRecordPrivilegeChanged^ cb);
	...
	public:
		...
		virtual void Add_CB_onRecordPrivilegeChanged(onRecordPrivilegeChanged^ cb)
		{
			event_onRecordPrivilegeChanged += cb;
		}

		virtual void Remove_CB_onRecordPrivilegeChanged(onRecordPrivilegeChanged^ cb)
		{
			event_onRecordPrivilegeChanged -= cb;
		}
	...
	private:
		...
		event onRecordPrivilegeChanged^ event_onRecordPrivilegeChanged;
