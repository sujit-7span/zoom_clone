...
SDKError ICustomizedResourceHelperWrap::AddCustomizedPictureResource(const zchar_t* key_, const zchar_t* absolute_resource_path)
{
...
SDKError ICustomizedResourceHelperWrap::AddCustomizedStringResource(SDKCustomizedStringType customizedType, const zchar_t* customizedString)
{
	if (customizedString)
	{
...
SDKError ICustomizedResourceHelperWrap::AddCustomizedURLResource(SDKCustomizedURLType customizedType, const zchar_t* customizedUrl)
{
	if (customizedType)
	{
