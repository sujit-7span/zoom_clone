...
IMPL_FUNC_1(IMeetingService, HandleZoomWebUriProtocolAction, SDKError, const zchar_t*, protocol_action, SDKERR_UNINITIALIZE)
...
IMPL_FUNC_AND_MEMBER(IMeetingService, T_GetMeetingAANController, IMeetingAANControllerWrap);
#endif
...
IMPL_FUNC_AND_MEMBER(IMeetingService, T_GetMeetingRawArchivingController, IMeetingRawArchivingControllerWrap);
IMPL_FUNC_AND_MEMBER(IMeetingService, T_GetMeetingReminderController, IMeetingReminderControllerWrap);
IMPL_FUNC_AND_MEMBER(IMeetingService, T_GetMeetingAICompanionController, IMeetingAICompanionControllerWrap);
...
IMPL_FUNC_0(IMeetingService, GetMeetingAANController, IMeetingAANController*, NULL)
IMPL_FUNC_0(IMeetingService, GetMeetingRawArchivingController, IMeetingRawArchivingController*, NULL)
IMPL_FUNC_0(IMeetingService, GetMeetingReminderController, IMeetingReminderController*, NULL)
IMPL_FUNC_0(IMeetingService, GetMeetingAICompanionController, IMeetingAICompanionController*, NULL)
#endif
