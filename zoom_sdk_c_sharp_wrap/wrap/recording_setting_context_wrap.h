...
DEFINE_FUNC_1(SetRecordingPath, SDKError, const zchar_t*, szPath)
//virtual const zchar_t* GetRecordingPath() = 0;
DEFINE_FUNC_0(GetRecordingPath, const zchar_t*)
...
DEFINE_FUNC_0(GetRecordingManagementURL, const zchar_t*)
