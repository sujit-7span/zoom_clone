...
DEFINE_FUNC_0(IsAnnotationDisable, bool)
//virtual SDKError StartAnnotation(SDKViewType viewtype, int left, int top) = 0;
DEFINE_FUNC_1(StartAnnotation, SDKError, SDKViewType, viewtype)
...
DEFINE_FUNC_0(IsAnnotationLegalNoticeAvailable, bool)
//virtual const zchar_t* getAnnotationLegalNoticesPrompt() = 0;
DEFINE_FUNC_0(getAnnotationLegalNoticesPrompt, const zchar_t*)
//virtual const zchar_t* getAnnotationLegalNoticesExplained() = 0;
DEFINE_FUNC_0(getAnnotationLegalNoticesExplained, const zchar_t*)
