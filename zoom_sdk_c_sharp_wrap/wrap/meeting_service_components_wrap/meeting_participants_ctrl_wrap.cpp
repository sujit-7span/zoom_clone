...
IMPL_FUNC_1(IMeetingParticipantsController, LowerAllHands, SDKError, bool, isWebinarAttendee, SDKERR_UNINITIALIZE)
//virtual SDKError ChangeUserName(const unsigned int userid, const zchar_t* userName, bool bSaveUserName) = 0;
IMPL_FUNC_3(IMeetingParticipantsController, ChangeUserName, SDKError, const unsigned int, userid, const zchar_t*, userName, bool, bSaveUserName, SDKERR_UNINITIALIZE)
...
IMPL_FUNC_1(IMeetingParticipantsController, ReclaimHostByHostKey, SDKError, const zchar_t*, host_key, SDKERR_UNINITIALIZE)
...
IMPL_FUNC_0(IMeetingParticipantsController, CanEnableParticipantRequestCloudRecording, bool, false)
//virtual bool IsParticipantRequestCloudRecordingAllowed() = 0;
IMPL_FUNC_0(IMeetingParticipantsController, IsParticipantRequestCloudRecordingAllowed, bool, false)
//virtual SDKError AllowParticipantsToRequestCloudRecording(bool bAllow) = 0;
IMPL_FUNC_1(IMeetingParticipantsController, AllowParticipantsToRequestCloudRecording, SDKError, bool, bAllow, SDKERR_UNINITIALIZE)
