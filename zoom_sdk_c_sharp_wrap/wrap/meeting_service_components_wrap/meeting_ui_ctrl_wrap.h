...
DEFINE_FUNC_1(SetMeetingTopic, SDKError, const zchar_t*, meetingtopic)
//virtual SDKError SetCustomizedCloudRecordingMgrUrl(const zchar_t* crmURL) = 0;
DEFINE_FUNC_1(SetCustomizedCloudRecordingMgrUrl, SDKError, const zchar_t*, crmURL)
//virtual SDKError SetCustomizedInvitationDomain(const zchar_t* invitation_domain) = 0;
DEFINE_FUNC_1(SetCustomizedInvitationDomain, SDKError, const zchar_t*, invitation_domain)
//virtual SDKError SetCustomizedPollingUrl(const zchar_t* pollingURL, bool bCreate) = 0;
DEFINE_FUNC_2(SetCustomizedPollingUrl, SDKError, const zchar_t*, pollingURL, bool, bCreate)
