...
DEFINE_FUNC_2(EnableMuteOnEntry, SDKError, bool, bEnable, bool, allowUnmuteBySelf)
...
CallBack_FUNC_2(onUserAudioStatusChange, IList<IUserAudioStatus* >*, lstAudioStatusChange, const zchar_t*, strAudioStatusList)
...
CallBack_FUNC_1(onJoin3rdPartyTelephonyAudio, const zchar_t*, audioInfo)
