...
DEFINE_FUNC_3(InviteCallOutUser, SDKError, const zchar_t*, countryCode, const zchar_t*, phoneNumber, const zchar_t*, name)
...
DEFINE_FUNC_2(CallMe, SDKError, const zchar_t*, countryCode, const zchar_t*, phoneNumber)
