...
IMPL_FUNC_0(IAnnotationController, IsAnnotationDisable, bool, false)
//virtual SDKError StartAnnotation(SDKViewType viewtype) = 0;
IMPL_FUNC_1(IAnnotationController, StartAnnotation, SDKError, SDKViewType, viewtype, SDKERR_UNINITIALIZE)
...
IMPL_FUNC_0(IAnnotationController, IsAnnotationLegalNoticeAvailable, bool, false)
//virtual const zchar_t* getAnnotationLegalNoticesPrompt() = 0;
IMPL_FUNC_0(IAnnotationController, getAnnotationLegalNoticesPrompt, const zchar_t*, NULL)
//virtual const zchar_t* getAnnotationLegalNoticesExplained() = 0;
IMPL_FUNC_0(IAnnotationController, getAnnotationLegalNoticesExplained, const zchar_t*, NULL)
