...
IMPL_FUNC_NORET_1(IMeetingConfiguration,SetDirectShareMonitorID, void, const zchar_t*, monitorID)
...
IMPL_FUNC_NORET_2(IMeetingConfiguration,PrePopulateWebinarRegistrationInfo, void, const zchar_t*, email, const zchar_t*, username)
...
IMPL_FUNC_NORET_1(IMeetingConfiguration, RedirectMeetingInputUserInfoDialog, void, bool, bRedirect)
//virtual void RedirectConfirmStartArchiveDialog(bool bRedirect) = 0;
IMPL_FUNC_NORET_1(IMeetingConfiguration, RedirectConfirmStartArchiveDialog, void, bool, bRedirect)
