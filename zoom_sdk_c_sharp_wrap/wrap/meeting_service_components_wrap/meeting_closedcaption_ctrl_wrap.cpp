...
IMPL_FUNC_1(IClosedCaptionController, SendClosedCaption, SDKError, const zchar_t*, ccMsg, SDKERR_UNINITIALIZE)
...
IMPL_FUNC_0(IClosedCaptionController, GetClosedCaptionHistorySavedPath, const zchar_t*, NULL)
//virtual const zchar_t* GetClosedCaptionUrlFor3rdParty() = 0;
IMPL_FUNC_0(IClosedCaptionController, GetClosedCaptionUrlFor3rdParty, const zchar_t*, NULL)
...
IMPL_FUNC_0(IClosedCaptionController, getLiveTranscriptLegalNoticesPrompt, const zchar_t*, NULL)
//virtual const zchar_t* getLiveTranscriptLegalNoticesExplained() = 0;
IMPL_FUNC_0(IClosedCaptionController, getLiveTranscriptLegalNoticesExplained, const zchar_t*, NULL)
