...
DEFINE_FUNC_0(GetH323Address, IList<const zchar_t* >*)
//virtual const zchar_t* GetH323Password() = 0;
DEFINE_FUNC_0(GetH323Password, const zchar_t*)
...
DEFINE_FUNC_2(SendMeetingParingCode, SDKError, UINT64, meetingNum, zchar_t*, paringCode)
