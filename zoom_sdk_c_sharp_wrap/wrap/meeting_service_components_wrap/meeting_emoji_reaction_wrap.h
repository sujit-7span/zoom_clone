...
CallBack_FUNC_1(OnEmojiReactionReceivedInWebinar, SDKEmojiReactionType, type)
//virtual void OnEmojiFeedbackReceived(unsigned int sender_id, SDKEmojiFeedbackType type) = 0;
CallBack_FUNC_2(OnEmojiFeedbackReceived, unsigned int, sender_id, SDKEmojiFeedbackType, type)
//virtual void OnEmojiFeedbackCanceled(unsigned int sender_id) = 0;
CallBack_FUNC_1(OnEmojiFeedbackCanceled, unsigned int, sender_id)
