...
IMPL_FUNC_1(IMeetingUIController, SetMeetingTopic, SDKError, const zchar_t*, meetingtopic, SDKERR_UNINITIALIZE)
//virtual SDKError SetCustomizedCloudRecordingMgrUrl(const zchar_t* crmURL) = 0;
IMPL_FUNC_1(IMeetingUIController, SetCustomizedCloudRecordingMgrUrl, SDKError, const zchar_t*, crmURL, SDKERR_UNINITIALIZE)
//virtual SDKError SetCustomizedInvitationDomain(const zchar_t* invitation_domain) = 0;
IMPL_FUNC_1(IMeetingUIController, SetCustomizedInvitationDomain, SDKError, const zchar_t*, invitation_domain, SDKERR_UNINITIALIZE)
//virtual SDKError SetCustomizedPollingUrl(const zchar_t* pollingURL, bool bCreate) = 0;
IMPL_FUNC_2(IMeetingUIController, SetCustomizedPollingUrl, SDKError, const zchar_t*, pollingURL, bool, bCreate, SDKERR_UNINITIALIZE)
