...
IMPL_FUNC_3(IMeetingPhoneHelper, InviteCallOutUser, SDKError, const zchar_t*, countryCode, const zchar_t*, phoneNumber, const zchar_t*, name, SDKERR_UNINITIALIZE)
...
IMPL_FUNC_2(IMeetingPhoneHelper, CallMe, SDKError, const zchar_t*, countryCode, const zchar_t*, phoneNumber, SDKERR_UNINITIALIZE)
