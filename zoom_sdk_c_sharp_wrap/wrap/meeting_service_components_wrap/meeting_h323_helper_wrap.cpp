...
IMPL_FUNC_0(IMeetingH323Helper, GetH323Address, IList<const zchar_t* >*, NULL)
//virtual const zchar_t* GetH323Password() = 0;
IMPL_FUNC_0(IMeetingH323Helper, GetH323Password, const zchar_t*, NULL)
//virtual SDKError SendMeetingParingCode(UINT64 meetingNum, zchar_t* paringCode) = 0;
IMPL_FUNC_2(IMeetingH323Helper, SendMeetingParingCode, SDKError, UINT64, meetingNum, zchar_t*, paringCode, SDKERR_UNINITIALIZE)
