...
DEFINE_FUNC_1(SetDirectShareMonitorID, void, const zchar_t*, monitorID)
...
DEFINE_FUNC_2(PrePopulateWebinarRegistrationInfo, void, const zchar_t*, email, const zchar_t*, username)
...
DEFINE_FUNC_1(RedirectMeetingInputUserInfoDialog, void, bool, bRedirect)
//virtual void RedirectConfirmStartArchiveDialog(bool bRedirect) = 0;
DEFINE_FUNC_1(RedirectConfirmStartArchiveDialog, void, bool, bRedirect)
...
CallBack_FUNC_2(onFreeMeetingNeedToUpgrade, FreeMeetingNeedUpgradeType, type_, const zchar_t*, gift_url)
...
CallBack_FUNC_1(onWebinarNeedInputScreenName, IWebinarInputScreenNameHandler*, handler_)
//virtual void onJoinMeetingNeedUserInfo(IMeetingInputUserInfoHandler* pHandler) = 0;
CallBack_FUNC_1(onJoinMeetingNeedUserInfo, IMeetingInputUserInfoHandler*, handler_)
//virtual void onUserConfirmToStartArchive(IMeetingArchiveConfirmHandler* pHandler) = 0;
CallBack_FUNC_1(onUserConfirmToStartArchive, IMeetingArchiveConfirmHandler*, handler_)
