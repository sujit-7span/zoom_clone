...
DEFINE_FUNC_2(SelectMic, SDKError, const zchar_t*, deviceId, const zchar_t*, deviceName)
...
DEFINE_FUNC_2(SelectSpeaker, SDKError, const zchar_t*, deviceId, const zchar_t*, deviceName)
...
CallBack_FUNC_2(onDefaultMicDeviceChanged, const zchar_t*, deviceId, const zchar_t*, deviceName)
//virtual void onDefaultSpeakerDeviceChanged(const zchar_t* deviceId, const zchar_t* deviceName) = 0;
CallBack_FUNC_2(onDefaultSpeakerDeviceChanged, const zchar_t*, deviceId, const zchar_t*, deviceName)
