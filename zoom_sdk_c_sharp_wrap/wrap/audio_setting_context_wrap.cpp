...
IMPL_FUNC_2(IAudioSettingContext, SelectMic, SDKError, const zchar_t*, deviceId, const zchar_t*, deviceName, SDKERR_UNINITIALIZE)
...
IMPL_FUNC_2(IAudioSettingContext, SelectSpeaker, SDKError, const zchar_t*, deviceId, const zchar_t*, deviceName, SDKERR_UNINITIALIZE)
