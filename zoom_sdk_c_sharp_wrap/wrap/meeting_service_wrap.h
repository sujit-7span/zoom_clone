...
DEFINE_FUNC_1(HandleZoomWebUriProtocolAction, SDKError, const zchar_t*, protocol_action)
...
DEFINE_FUNC_0(GetMeetingEmojiReactionController, IEmojiReactionController*)
DEFINE_FUNC_0(GetMeetingAANController, IMeetingAANController*)
DEFINE_FUNC_0(GetMeetingRawArchivingController, IMeetingRawArchivingController*)
DEFINE_FUNC_0(GetMeetingReminderController, IMeetingReminderController*)
DEFINE_FUNC_0(GetMeetingAICompanionController, IMeetingAICompanionController*)
public:
...
#define T_GetMeetingEmojiReactionController _GetMeetingEmojiReactionController
#define T_GetMeetingAANController _GetMeetingAANController
#define T_GetMeetingRawArchivingController _GetMeetingRawArchivingController
#define T_GetMeetingReminderController _GetReminderController
#define T_GetMeetingAICompanionController _GetMeetingAICompanionController
#else
#if defined(WIN32)
...
#define T_GetMeetingEmojiReactionController GetMeetingEmojiReactionController
#define T_GetMeetingAANController GetMeetingAANController
#endif
...
#define T_GetMeetingRawArchivingController GetMeetingRawArchivingController
#define T_GetMeetingReminderController GetReminderController
#define T_GetMeetingAICompanionController GetMeetingAICompanionController
#endif
#if defined(WIN32)
...
DEFINE_FUNC_AND_MEMBER(T_GetMeetingAANController, IMeetingAANControllerWrap)
#endif
...
DEFINE_FUNC_AND_MEMBER(T_GetMeetingRawArchivingController, IMeetingRawArchivingControllerWrap)
DEFINE_FUNC_AND_MEMBER(T_GetMeetingReminderController, IMeetingReminderControllerWrap)
DEFINE_FUNC_AND_MEMBER(T_GetMeetingAICompanionController, IMeetingAICompanionControllerWrap)
...
CallBack_FUNC_0(onSuspendParticipantsActivities)
//virtual void onAICompanionActiveChangeNotice(bool bActive) = 0;
CallBack_FUNC_1(onAICompanionActiveChangeNotice, bool, bActive)
