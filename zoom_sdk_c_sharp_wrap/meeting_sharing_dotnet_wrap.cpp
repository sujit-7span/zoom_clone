...
namespace ZOOM_SDK_DOTNET_WRAP {
	...
	SDKError CMeetingShareControllerDotNetWrap::GetViewableShareSourceByUserID(unsigned int userid, ViewableShareSource^% shareSource)
	{
		...
		SDKError err = (SDKError)ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().
			GetMeetingShareController().GetViewableShareSourceByUserID(userid, shareSource_c);
