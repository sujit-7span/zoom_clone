...
namespace ZOOM_SDK_DOTNET_WRAP {
	...
	public:
		...
		SDKError GetViewableShareSourceByUserID(unsigned int userid, ViewableShareSource^% shareSource);
	...
	public:
		...
		virtual SDKError GetViewableShareSourceByUserID(unsigned int userid, ViewableShareSource^% shareSource);
